...
public class DrivingLicence extends Documents {
    ...
    protected void updateKeywords() {
        //********************** FRONT SIDE ********************//
        this.keywords.put(this.getClass().getName(), 60);
        this.keywords.put("INDIANUNIONDRIVINGLICENCE", 30);
        this.keywords.put("LICENCINGAUTHORITY", 30);
        this.keywords.put("VALIDTILL", 5);
// *****this.************************************Back Side
        this.keywords.put("DRIVINGLICENCE", 20);
        ...
        this.keywords.put("REFERENCE NO", 5);
